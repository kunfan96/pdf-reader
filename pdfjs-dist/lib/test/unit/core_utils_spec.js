...
describe("core_utils", function () {
  ...
  describe("isSpace", function () {
    it("handles space characters", function () {
      expect((0, _core_utils.isSpace)(0x20)).toEqual(true);
      expect((0, _core_utils.isSpace)(0x09)).toEqual(true);
      expect((0, _core_utils.isSpace)(0x0d)).toEqual(true);
      expect((0, _core_utils.isSpace)(0x0a)).toEqual(true);
    });
    it("handles non-space characters", function () {
      expect((0, _core_utils.isSpace)(0x0b)).toEqual(false);
      expect((0, _core_utils.isSpace)(null)).toEqual(false);
      expect((0, _core_utils.isSpace)(undefined)).toEqual(false);
    });
  });
});